...
(function () {
    ...
    const pageList = [
        new PageModel('./static/img/bridge.jpg',
        ...
        new PageModel('./static/img/Golden-Gate-Bridge-San-Francisco.png',
        "Golden Gate Bridge",
        ...
        new PageModel('./static/img/forth_bridge.jpg',
        "Forth Bridge",
